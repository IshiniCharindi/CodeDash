...
const DifficultSection = () => {
    ...
    useEffect(() => {
        axios.get("http://localhost/CodeDash/Backend/Controllers/DifficultCodeSnippetViewController.php")
            .then((response) => {
                        ...
                        <div className="flex justify-between mt-6">
                            ...
                            {currentIndex + 1 < snippets.length ? (
                                ...
                                <div>
                                    ...
                                    <a href="/easy">
                                        <button className="px-4 bg-[#598392] hover:bg-[#124559] text-white rounded-lg transition-colors backdrop-blur-sm">Back to easy section</button>
                                    </a>
                                </div>)}
                        </div>
                    </div>
...
export default DifficultSection;
